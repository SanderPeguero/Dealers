        ...
        <div className="overflow-x-auto">
            ...
            <div className='md:flex md:justify-start m-auto w-full'>
                <div className='flex justify-between md:w-[300px] px-2 mb-4 md:mb-0'>
                    <input
                        ...
                        className=' bg-gray-100 dark:bg-[#12232E] w-full text-black dark:text-white rounded-xl h-14 border-indigo-400 focus:outline-none px-2'
                ...
                <div className='flex justify-between md:w-[300px] px-2'>
                    <input
                        ...
                        className='w-full bg-gray-100 dark:bg-[#12232E] text-black dark:text-white rounded-xl h-14 border-indigo-400 focus:outline-none px-2'
                ...
                <div className='flex justify-between md:w-[300px] px-2'>
                    <input
                        type="date"
                        value={DateFilter}
                        className='w-full bg-gray-100 dark:bg-[#12232E] text-black dark:text-white rounded-xl h-14 border-indigo-400 focus:outline-none px-2 mb-2'
                        placeholder='Escriba el nombre del Auto'
            ...
            <div className="min-w-full inline-block align-middle">
                <div className="overflow-hidden rounded-lg  shadow-md m-5">
                    <table className="min-w-full divide-y divide-gray-600 dark:bg-[#12232E] text-left text-sm shadow-md">
                        <thead className=" bg-white dark:bg-[#0e1b24]">
                            <tr>
                                ...
                                <th scope="col" className="px-6 py-4 font-medium text-black dark:text-gray-100">Email</th>
                                <th scope="col" className="px-6 py-4 font-medium text-black dark:text-gray-100">Auto</th>
                                <th scope="col" className="px-6 py-4 font-medium text-black dark:text-gray-100">Precio</th>
                                <th scope="col" className="px-6 py-4 font-medium text-black dark:text-gray-100">Fecha</th>
                                <th scope="col" className="px-6 py-4 font-medium text-black dark:text-gray-100">Hora</th>
                        ...
                        <tbody className="divide-y divide-gray-600 border-t border-gray-600">
                            {FilterReservas.map((reserva) => (
                                <tr key={reserva.id} onClick={() => handleOpenDetails(reserva.IdReservedcar)} className=" hover:bg-gray-200 dark:hover:bg-gray-900 text-gray-900 dark:text-gray-100 max-w-full">
                                    ...
                                    <th className="flex gap-3 px-6 py-4 font-normal text-gray-100">
                                        <div className="text-sm">
                                            <div className="font-medium text-black dark:text-gray-100">{reserva.informationVehicle?.Title}</div>
                                            <div className="text-gray-700 dark:text-gray-400">Condición: {reserva.informationVehicle?.condition} <br />
                                    ...
                                    <td>
                                        <div className='  dark:text-gray-100 mx-2'>{reserva.informationUser?.ReservationDate}</div>
                                    </td>
                                    <td>
                                        <div className=' dark:text-gray-100 mx-2'>{reserva.informationUser?.ReservationTime}</div>
                                    </td>
                                    <th>
