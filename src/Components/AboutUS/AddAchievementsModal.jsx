...
function AddAchievementsModal({openAchievementsModal, HandleCloseAchievementsModal}) {
    ...
    const handleSaveImage = async () => {
        ...
        if (selectedImage) {
            const fileUrl = await uploadAchievementsImg(selectedImage);
            if (fileUrl) {
                const NewAchievementsImg = {
                    UrlAchievementsImg: fileUrl
                };
                await AddAchievementsImg(NewAchievementsImg);
                setCheckAbout(true)
                setSelectedImage(null);
                setURLImage('');
    ...
    if (!openAchievementsModal) return null;
  return (
