...
import {uploadFirstImageAbout, AddNewFirstImageAbout } from '../../Functions/HomeAdmin/HomeAdmin';
import { useContextCar } from '../../Context/Context';
import { useState } from 'react';

function AddPresentationImage({openPresentationModal, HandleCloseModal}) {
    ...
    const handleSaveImage = async () => {
        ...
        if (selectedImage) {
            ...
            if (fileUrl) {
                const NewPresentationImage = {
                    UrlPresentationImage: fileUrl
                };
                await AddNewFirstImageAbout(NewPresentationImage);
                setCheckAbout(true)
                setSelectedImage(null);
                setURLImage('');
    ...
    if (!openPresentationModal) return null;
  return (
...
export default AddPresentationImage